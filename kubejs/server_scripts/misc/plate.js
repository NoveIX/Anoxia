ServerEvents.recipes((event) => {
  ...
  const platePattern = [
    ...
    { get: 'chemlib:aluminum_plate', put: 'forge:ingots/aluminum', molten: 'aluminum', material: material.aluminum, rsflux: 8000 },
    ...
    { get: 'chemlib:chromium_plate', put: 'forge:ingots/chromium', molten: 'chromium', material: material.chromium, rsflux: 8000 },
    { get: 'chemlib:manganese_plate', put: 'forge:ingots/manganese', rsflux: 8000 },
    { get: 'chemlib:cobalt_plate', put: 'forge:ingots/cobalt', molten: 'cobalt', material: material.cobalt, rsflux: 8000 },
    { get: 'chemlib:zinc_plate', put: 'forge:ingots/zinc', molten: 'zinc', material: material.zinc, rsflux: 8000 },
    ...
    { get: 'chemlib:cadmium_plate', put: 'forge:ingots/cadmium', molten: 'cadmium', material: material.cadmium, rsflux: 8000 },
    ...
    { get: 'chemlib:tungsten_plate', put: 'forge:ingots/tungsten', molten: 'tungsten', material: material.tungsten, rsflux: 8000 },
    { get: 'chemlib:rhenium_plate', put: 'forge:ingots/rhenium', rsflux: 8000 },
    { get: 'chemlib:osmium_plate', put: 'forge:ingots/osmium', molten: 'osmium', material: material.osmium, rsflux: 8000 },
    { get: 'chemlib:iridium_plate', put: 'forge:ingots/iridium', rsflux: 8000 },
    { get: 'chemlib:platinum_plate', put: 'forge:ingots/platinum', molten: 'platinum', material: material.platinum, rsflux: 8000 },
    ...
    { get: 'chemlib:uranium_plate', put: 'forge:ingots/uranium', molten: 'uranium', material: material.uranium, rsflux: 8000 },
