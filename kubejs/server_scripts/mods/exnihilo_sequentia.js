ServerEvents.recipes((event) => {
  ...
  const heatPattern = [
    ...
    { under: 'minecraft:magma_block', multi: 2 },
    ...
    { under: 'bigreactors:magentite_block', multi: 50 },
    { under: 'bigreactors:ludicrite_block', multi: 60 },
    { under: 'bigreactors:ridiculite_block', multi: 70 },
    { under: 'bigreactors:inanite_block', multi: 80 },
    { under: 'bigreactors:insanite_block', multi: 90 },
