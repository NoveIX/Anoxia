ServerEvents.recipes((event) => {
	...
	event.shaped("enderio:primitive_alloy_smelter", ["EHE", "BVB", "GCG"], { E: "#forge:ingots/ender_ingot", H: "immersiveengineering:connector_hv", B: "actuallyadditions:powered_furnace", V: "enderio:void_chassis", G: "#forge:gears/rose_gold", C: "thermal:energy_cell" });
