ServerEvents.recipes((event) => {
	...
	event.shaped("actuallyadditions:powered_furnace", ["IHI", "GFG", "TCT"], { I: "#forge:plates/iron", H: "immersiveengineering:connector_mv", G: "ironfurnaces:gold_furnace", F: "actuallyadditions:iron_casing", T: "#forge:gears/tin", C: "actuallyadditions:advanced_coil" });

	//#region Empowering
	const EmpoweringPattern = [
		{ get: { item: "enderio:double_layer_capacitor" }, put: { tag: "forge:dusts/coal" }, extra: [{ item: "enderio:basic_capacitor" }, { item: "enderio:basic_capacitor" }, { tag: "forge:ingots/energetic_alloy" }, { tag: "forge:ingots/energetic_alloy" }], rsflux: 3750, color: 3335679, sec: 600 },
		{ get: { item: "enderio:octadic_capacitor" }, put: { tag: "forge:storage_blocks/glowstone" }, extra: [{ item: "enderio:double_layer_capacitor" }, { item: "enderio:double_layer_capacitor" }, { tag: "forge:ingots/vibrant_alloy" }, { tag: "forge:ingots/vibrant_alloy" }], rsflux: 7500, color: 2745239, sec: 900 },
	];
