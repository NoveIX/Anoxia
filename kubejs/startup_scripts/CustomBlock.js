...
MMEvents.registerControllers(event => {
    event.create("machine_controller") //ID
...
MMEvents.registerExtraBlocks(event => {
    //#region Extra Block
    //Vent
    event.create("machine_vent")
        .type("mm:vent")
        .name("Machine Vent")

    //Gearbox
    event.create("machine_gearbox")
        .type("mm:gearbox")
        .name("Machine Gearbox")

    //Circuit
    event.create("machine_circuit")
        .type("mm:circuit")
...
MMEvents.registerPorts(event => {
    ...
    //Reinforced
    event.create("reinforced_item_port")
    ...
    //Ludicrous
    event.create("ludicrous_item_port")
        ...
        .config("mm:item", c => {
            ...
            //Ultimate
    event.create("ultimate_item_port")
    ...
    //Normal
    event.create("normal_fluid_port")
    ...
    //Reinforced
    event.create("reinforced_fluid_port")
    ...
    //Ludicrous
    event.create("ludicrous_fluid_port")
        ...
        .config("mm:fluid", c => {
            ...
            //Ultimate
    event.create("ultimate_fluid_port")
    .name("Ultimate Fluid Port")
    .controllerId("mm:controller")
    .config("mm:fluid", c => {
        c.rows(1)
            .columns(1)
            .slotCapacity(2147483647);
    })
    //#endregion
    ...
    //Small
    event.create("small_energy_port")
    ...
    //Normal
    event.create("normal_energy_port")
    ...
    //Reinforced
    event.create("reinforced_energy_port")
    ...
    //ludicrous
    event.create("ludicrous_energy_port")
    ...
    //Ultimate
    event.create("ultimate_energy_port")
